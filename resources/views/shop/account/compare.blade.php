    ...
    <div class="hb-compare-page">
        <header class="hb-compare-header">
            ...
            @if($products->isNotEmpty())
                <form method="post" action="{{ route('shop.account.compare.clear') }}">
                    @csrf
                    @method('DELETE')
                            ...
                            @foreach($products as $product)
                                ...
                                <th class="hb-compare-product-col">
                                    <article class="hb-compare-product-card">
                                        <form method="post" action="{{ route('shop.account.compare.toggle', $product) }}" class="hb-compare-remove-form">
                                            @csrf
